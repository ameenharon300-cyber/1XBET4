...
console.log('🤖 بدء تشغيل AI GOAL Predictor Ultimate v10.8...');
...
// 🎯 ADVANCED IMAGE VALIDATION WITH OPENAI VISION - STRICT GOAL GAME DETECTION
class ImageValidator {
    ...
    async validateImage(imageUrl) {
        try {
            console.log('🔍 جاري التحقق من الصورة باستخدام OpenAI Vision...');
...
// 🖼️ IMAGE ANALYSIS HANDLER - UPDATED WITH STRICT VALIDATION
bot.on('photo', async (ctx) => {
    try {
        ...
        // التحقق من صحة الصورة باستخدام OpenAI Vision - تحقق صارم
...
// 🚀 START BOT
bot.launch().then(() => {
    console.log('🎉 نجاح! AI GOAL Predictor v10.8 يعمل الآن!');
...
console.log('✅ نظام توقع الأهداف بالذكاء الاصطناعي جاهز!');
